...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::put('/profile' , [UserController::class , 'setProfile']);
    Route::get('/profile/{user}' , [UserController::class , 'getProfile']);
    Route::post('/follow/{follow}' , [FollowContorller::class , 'toggleFollow']);
    Route::get('/follow/{follow}' , [FollowContorller::class , 'isFollowed']);
    ...
    Route::apiResource('category', CategoryController::class)->only(['index', 'show' ,'store']);
    ...
    Route::apiresource('chat',ChatController::class)->only(['index','store','show','destory']);
